...
function Navbar({
  ...
  return (
    <nav className='sticky top-0 z-50 flex items-center justify-between w-full py-3 pl-4 pr-6 bg-white bg-opacity-90 backdrop-blur-sm md:px-0'>
      <div className='flex'>
        <button className='inline-flex items-center justify-center flex-shrink-0 p-2 md:hidden'>
